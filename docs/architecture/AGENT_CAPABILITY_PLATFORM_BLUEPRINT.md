...
- [`ReproductionSpec v1`](../specs/REPRODUCTION_SPEC_V1.md)；
- [`Baseline Vertical Slice`](../specs/BASELINE_VERTICAL_SLICE.md)；
- [`ADR-001` 至 `ADR-005`](../adr/)；
...
[`docs/specs/REPRODUCTION_SPEC_V1.md`](../specs/REPRODUCTION_SPEC_V1.md)

对应机器可校验 Schema：

[`reproduction-spec-v1.schema.json`](../specs/reproduction-spec-v1.schema.json)
...
[`BASELINE_VERTICAL_SLICE.md`](../specs/BASELINE_VERTICAL_SLICE.md)
