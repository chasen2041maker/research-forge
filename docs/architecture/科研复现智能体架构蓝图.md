...
- [`科研复现任务规范 v1`](../specs/科研复现任务规范_v1.md)；
- [`基线复现纵向切片规范`](../specs/基线复现纵向切片规范.md)；
...
[`docs/specs/科研复现任务规范_v1.md`](../specs/科研复现任务规范_v1.md)

对应机器可校验 Schema：

[`科研复现任务规范_v1.schema.json`](../specs/科研复现任务规范_v1.schema.json)
...
[`基线复现纵向切片规范.md`](../specs/基线复现纵向切片规范.md)
