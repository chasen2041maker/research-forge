...
Accepted — partially implemented. PostgreSQL ownership is covered for Forge Mission state; the full
cross-store reconciliation described by ADR-003 is not yet delivered.
